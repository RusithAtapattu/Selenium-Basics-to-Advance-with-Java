...
public class JavascriptExecutorExample {
    ...
    public void jsExecutorTests() throws InterruptedException {
        ...
        //1) Get an Alert Box in to Web page using javaScript
//        jsExecutor.executeScript("alert('Welcome to Selenium...');");



        //2) Set an input value in a text box using javascriptExecutor
...
//        jsExecutor.executeScript("arguments[0].value='Welcome to Selenium';",inputNameTextBox);


            //2.2) - way 2 > Set the value using setAttribute (alternative approach)

        jsExecutor.executeScript("arguments[0].setAttribute('value', 'Welcome to Selenium');",inputNameTextBox);
        Thread.sleep(4000);
